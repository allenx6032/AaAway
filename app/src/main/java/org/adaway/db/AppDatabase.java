...
public abstract class AppDatabase extends RoomDatabase {
    ...
    private static void initialize(Context context, AppDatabase database) {
        ...
        source4.setLabel("AWAvenue Ads Ruler");
        source4.setUrl("https://ghfast.top/https://raw.githubusercontent.com/TG-Twilight/AWAvenue-Ads-Rule/main/Filters/AWAvenue-Ads-Rule-hosts.txt");
